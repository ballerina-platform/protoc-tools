...
public const map<string> PACKAGEWITHENUMIMPORTS_DESCRIPTOR_MAP = {"enumMessage.proto": messages:ENUMMESSAGE_DESC};
...
public isolated client class helloWorldClient {
    *grpc:AbstractClientEndpoint;
    ...
    public isolated function init(string url, *grpc:ClientConfiguration config) returns grpc:Error? {
        ...
        check self.grpcClient.initStub(self, PACKAGEWITHENUMIMPORTS_DESC, PACKAGEWITHENUMIMPORTS_DESCRIPTOR_MAP);
    }

...
public const map<string> PACKAGEWITHIMPORTCONTAININGSERVICE_DESCRIPTOR_MAP = {"messageWithService.proto": message:MESSAGEWITHSERVICE_DESC};
...
public isolated client class helloWorldClient {
    *grpc:AbstractClientEndpoint;
    ...
    public isolated function init(string url, *grpc:ClientConfiguration config) returns grpc:Error? {
        ...
        check self.grpcClient.initStub(self, PACKAGEWITHIMPORTCONTAININGSERVICE_DESC, PACKAGEWITHIMPORTCONTAININGSERVICE_DESCRIPTOR_MAP);
    }

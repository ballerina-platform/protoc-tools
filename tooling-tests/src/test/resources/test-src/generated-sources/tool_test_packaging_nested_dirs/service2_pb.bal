...
public const map<string> SERVICE2_DESCRIPTOR_MAP = {"messages1.proto": messages:MESSAGES1_DESC};
...
public isolated client class MyService2Client {
    *grpc:AbstractClientEndpoint;
    ...
    public isolated function init(string url, *grpc:ClientConfiguration config) returns grpc:Error? {
        ...
        check self.grpcClient.initStub(self, SERVICE2_DESC, SERVICE2_DESCRIPTOR_MAP);
    }

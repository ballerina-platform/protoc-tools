...
public const map<string> PACKAGEWITHMESSAGEIMPORT_DESCRIPTOR_MAP = {"message.proto": message:MESSAGE_DESC};
...
public isolated client class helloWorldClient {
    *grpc:AbstractClientEndpoint;
    ...
    public isolated function init(string url, *grpc:ClientConfiguration config) returns grpc:Error? {
        ...
        check self.grpcClient.initStub(self, PACKAGEWITHMESSAGEIMPORT_DESC, PACKAGEWITHMESSAGEIMPORT_DESCRIPTOR_MAP);
    }

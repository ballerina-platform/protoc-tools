...
public const map<string> SERVICE_DESCRIPTOR_MAP = {"messages1.proto": MESSAGES1_DESC, "messages2.proto": MESSAGES2_DESC};
...
public isolated client class MyServiceClient {
    *grpc:AbstractClientEndpoint;
    ...
    public isolated function init(string url, *grpc:ClientConfiguration config) returns grpc:Error? {
        ...
        check self.grpcClient.initStub(self, SERVICE_DESC, SERVICE_DESCRIPTOR_MAP);
    }

...
public const map<string> PACKAGEWITHNESTEDSUBMODULES_DESCRIPTOR_MAP = {"message1.proto": message1:MESSAGE1_DESC, "message2.proto": message2:MESSAGE2_DESC};
...
public isolated client class helloWorldClient {
    *grpc:AbstractClientEndpoint;
    ...
    public isolated function init(string url, *grpc:ClientConfiguration config) returns grpc:Error? {
        ...
        check self.grpcClient.initStub(self, PACKAGEWITHNESTEDSUBMODULES_DESC, PACKAGEWITHNESTEDSUBMODULES_DESCRIPTOR_MAP);
    }

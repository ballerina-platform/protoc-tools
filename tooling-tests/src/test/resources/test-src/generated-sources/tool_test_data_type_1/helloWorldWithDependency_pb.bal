...
public const map<string> descriptorMap = {"message.proto": MESSAGE_DESC, "lib/message.proto": LIB / MESSAGE_DESC};
...
public isolated client class helloWorldWithDependencyClient {
    *grpc:AbstractClientEndpoint;
    ...
    public isolated function init(string url, *grpc:ClientConfiguration config) returns grpc:Error? {
        ...
        check self.grpcClient.initStub(self, HELLOWORLDWITHDEPENDENCY_DESC, descriptorMap);
    }

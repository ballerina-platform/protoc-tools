...
public isolated client class HelloWorldHelloCaller {
    ...
    isolated remote function sendHello(Hello response) returns grpc:Error? {
        return self.caller->send(response);
    }

    isolated remote function sendContextHello(ContextHello response) returns grpc:Error? {
        return self.caller->send(response);
    }

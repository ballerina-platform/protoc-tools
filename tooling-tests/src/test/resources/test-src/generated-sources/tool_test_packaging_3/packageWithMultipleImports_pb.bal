...
public const map<string> PACKAGEWITHMULTIPLEIMPORTS_DESCRIPTOR_MAP = {"message1.proto": message1:MESSAGE1_DESC, "message2.proto": message2:MESSAGE2_DESC};
...
public isolated client class helloWorldClient {
    *grpc:AbstractClientEndpoint;
    ...
    public isolated function init(string url, *grpc:ClientConfiguration config) returns grpc:Error? {
        ...
        check self.grpcClient.initStub(self, PACKAGEWITHMULTIPLEIMPORTS_DESC, PACKAGEWITHMULTIPLEIMPORTS_DESCRIPTOR_MAP);
    }

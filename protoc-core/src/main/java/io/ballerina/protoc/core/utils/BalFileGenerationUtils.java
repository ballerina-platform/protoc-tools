 ...
 *  under the License.
 */
package io.ballerina.protoc.core.utils;
...
public class BalFileGenerationUtils {
    ...
    private static String formatProtoError(String rawError) {
        ...
        formatted.append("Error: Failed to generate Ballerina files from proto definition.").append(System.lineSeparator());
        formatted.append(System.lineSeparator());
        formatted.append("Proto compilation failed with the following error:").append(System.lineSeparator());
